...
<body>
<center><h2>FindTrains</h2></center>
<br>
<form:form method="GET" action="findtraincountersucc1.html">
<table border="0" align="center" cellpadding="3" cellspacing="2">
			   
			    <tr>
			        <td cssStyle="height:20px"><form:label path="source">Source:</form:label></td>
			      ...
			      <tr>
			        <td cssStyle="height:20px"><form:label path="destination">Destination:</form:label></td>
			        <td><form:input path="destination" id="ss1" cssClass="txt" cssStyle="height:18px;"/></td><td style="color: red"><form:errors path="destination"/></td>
			    </tr>
