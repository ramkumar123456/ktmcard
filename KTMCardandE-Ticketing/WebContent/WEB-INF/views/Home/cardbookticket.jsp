...
<title>Book Ticket Using KTM Card</title>
...
<form:form action="cardtrainsearch1.html" method="POST">
 
<%-- <form:form name="f" action="j_spring_security_check" method='POST'>
 --%><table border="0" align="center" cellpadding="3" cellspacing="2">
<tr><td cssStyle="height:20px">Enter your KTM card number</td><td cssStyle="width:18px;">:</td>
<td><form:input path="cardid" cssClass="txt" cssStyle="height:18px;"/></td><td><form:errors path="cardid" cssClass="error"/></td></tr>
<tr><td></td>
<td colspan="2" align="center"><input type="submit" Class="button" value="Submit" /></td></tr>
