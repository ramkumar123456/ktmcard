...
<center>
    <%-- <c:if test="${not empty error}">
      Error:${sessionScope["SPRING_SECURITY_LAST_EXCEPTION"].message}	
		<div class="errorblock" id="d" style="color:Red;">			
			${error}	
	  	</div>
	  </c:if> --%>
<%-- <form:form action="/KTMCardandE-Ticketing/logsuc.html" method="GET">
 --%> <br>
 <form:form action="j_spring_security_check" >
	<c:if test="${not empty error}"><div style="color: red;">${error}</div></c:if><br>
