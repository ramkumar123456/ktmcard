...
<div align="center">
<form:form action="/KTMCardandE-Ticketing/registersuccess.html" method="POST">
...
<td><form:input path="username" cssClass="txt" styleId="username" onchange="unique()" cssStyle="height:18px;" /></td><td><span id="sid" style="color:red"></span><form:errors path="username" cssClass="error"></form:errors></td></tr>
...
<tr><td cssStyle="height:20px">Conform Password</td><td cssStyle="width:18px;">:</td>
...
<tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr><td></td>
 <td colspan="2" align="center"><input type="submit" value="Register" Class="button"/>&nbsp&nbsp&nbsp&nbsp
