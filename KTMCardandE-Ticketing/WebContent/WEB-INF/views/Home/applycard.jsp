   ...
   function getStates(country)
{
    ...
    <script>
      ...
      <script>
      function employee(){
    		var u= document.getElementById("employeeid").value;
  
    		$.ajax({
    				
    				url:'employeeiduniqueforuser.html',
    				...
    				var e = result.trim().split(",");
    					...
    					for (var i=0;i<e.length;i++)
    						...
    						if(u == e[i])
    							...
    							document.getElementById("eid").innerHTML ="EmployeeID " + u  + " already exists please try another name";
      ...
      function unique(){
    		var u= document.getElementById("username").value;
    			...
    			$.ajax({
    				...
    				url:'usernameuniqueforuser.html',
    				success:function(result)
    				{
    				var e = result.trim().split(",");
...
<body onload="lng();">
<br><br><br>
<h2 align="center">Apply Card</h2>
<div align="center"><br><br><br><br>
<form:form action="/KTMCardandE-Ticketing/applycardtopuppage.html" method="POST">
<table border="0" align="center" cellpadding="3" cellspacing="2">
<%-- <tr><td cssStyle="height:20px">CardType</td><td cssStyle="width:18px;">:</td>
<td><form:radiobutton path="cardtype" value="physicalcard" id="male"/>PhysicalCard&nbsp&nbsp&nbsp
<form:radiobutton path="cardtype" value="virtualcard" id="female"/>VirtualCard
</td><td><form:errors path="cardtype" cssClass="error"></form:errors></td></tr> --%>
...
<td><form:input path="email" cssClass="txt" cssStyle="height:18px;" styleId="email"/></td><td><form:errors path="email" cssClass="error"></form:errors></td></tr>
...
<%-- <tr><td>Country:</td>
<td><form:select path="country" style="width:160px"  /><script language="javascript">
              populateCountries("country", "state");
             populateCountries("country2");
			</script></td><td><form:errors path="country" cssClass="error"></form:errors></td></tr>
<tr><td>State:</td>
<td><form:select path="state" style="width:160px" /></td><td><form:errors path="state" cssClass="error"></form:errors></td></tr> --%>
...
<tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr><td></td>
 <td colspan="2" align="center"><input type="submit" value="Apply" Class="button"/>&nbsp&nbsp&nbsp&nbsp
