...
<body>
<h1 align="center">Initial TopUp Page</h1>
<form:form action="paymentpage1.html" method="POST">
 ...
 <tr><td cssStyle="height:20px">Amount</td><td cssStyle="width:18px;">:</td>
		<td><form:select path="country" cssClass="txt" id="country" cssStyle="width:162px;height:23px" onchange="getStates(this.value);">
								  ...
								  <option value= '2000'>2000</option> </form:select></td> <td><form:errors path="country" cssClass="error" /></td></tr>
...
<tr><td align="center"><a href="creditcard.html">CreditCard</a></td></tr>
<tr><td align="center"><a href="debitcard.html">DebitCard</a></td></tr>
<tr><td align="center"><a href="netbanking.html">NetBanking</a></td></tr> -->
