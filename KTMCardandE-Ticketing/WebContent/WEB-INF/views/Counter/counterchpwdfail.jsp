...
<%-- <security:authorize ifAnyGranted="ROLE_User">
 --%><h1 align="center">ChangePassword</h1>
 	<h3 align="center"> <font  color="red">OldPassword Is Incorrect</font></h3>
<form:form action="/KTMCardandE-Ticketing/counterchangepasswordsucc.html" method="POST">
<table border="0" align="center" cellpadding="3" cellspacing="2">

<tr><td cssStyle="height:20px">OldPassword</td><td cssStyle="width:18px;">:</td>
...
<tr><td cssStyle="height:20px">NewPassword</td><td cssStyle="width:18px;">:</td>
...
<tr><td cssStyle="height:20px">ConformNewPassword</td><td cssStyle="width:18px;">:</td>
