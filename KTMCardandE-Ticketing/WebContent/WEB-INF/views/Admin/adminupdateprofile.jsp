...
<div align="center">
<br>
<form:form action="/KTMCardandE-Ticketing/adminupdateprofilesucc.html" method="POST">
...
<tr><td></td><td></td> <td colspan="2" align="left"><input type="submit" value="Update" Class="button"/></td>
 </tr>
</table>
 </form:form>
</div>
