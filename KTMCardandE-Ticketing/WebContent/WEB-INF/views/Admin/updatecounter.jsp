...
<form:form action="/KTMCardandE-Ticketing/updatecountersuccs.html" method="POST">
...
<td><form:input path="username" readonly="true" cssClass="txt" cssStyle="height:18px;" styleId="username"/></td><td><form:errors path="username" cssClass="error"></form:errors></td></tr>
<tr>
		<td></td>
...
<td><form:input path="stationname" cssClass="txt" cssStyle="height:18px;" styleId="stationname" readonly="true"/></td><td><form:errors path="stationname" cssClass="error"></form:errors></td></tr>
<tr><td cssStyle="height:20px">StationCode</td><td cssStyle="width:18px;">:</td>
<td><form:input path="stationcode" cssClass="txt" styleId="stationcode" onchange="unique()" cssStyle="height:18px;" readonly="true"/></td><td><span id="sid" style="color:red"></span><form:errors path="stationcode" cssClass="error"></form:errors></td></tr>
