...
<br>
<h2 align="center">Update Station</h2>
		<form:form method="GET" action="updatestationsucc.html">
<table border="0" align="center" cellpadding="3" cellspacing="2">
		...
		<td><form:hidden path="stationid"/></td>
			    ...
			    <tr>
			        ...
			        <td><form:input path="stationname" cssClass="txt" cssStyle="height:18px;"/></td>
			        <td><form:errors path="stationname" cssClass="error"></form:errors></td>
			    </tr>
			    <tr>
			        <td><form:label path="stationcode" cssStyle="height:20px">Station Code:</form:label></td>
			        <td><form:input path="stationcode" cssClass="txt" cssStyle="height:18px;"/></td>
			        <td><form:errors path="stationcode" cssClass="error"></form:errors></td>
			    </tr>
