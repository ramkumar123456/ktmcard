...
<br>
<h2 align="center">Book A Ticket</h2>
<div align="center">
<form:form action="/KTMCardandE-Ticketing/trainslist1.html" method="GET">
<table border="0" align="center" cellpadding="3" cellspacing="2">
<tr><td cssStyle="height:20px">Source</td><td cssStyle="width:18px;">:</td>
<td><form:input path="from" cssClass="txt" cssStyle="height:18px;" styleId="from"/></td><td><form:errors path="from" cssClass="error"></form:errors></td></tr>
<tr><td cssStyle="height:20px">Destination</td><td cssStyle="width:18px;">:</td>
<td><form:input path="to" cssClass="txt" cssStyle="height:18px;" styleId="to"/></td><td><form:errors path="to" cssClass="error"></form:errors></td></tr>

<tr>
<tr><td cssStyle="height:20px">Date</td><td cssStyle="width:18px;">:</td>
<td><form:input path="date" class="easyui-datebox"  cssStyle="txt:height:12px;" id="dateofbirth" editable="false"/></td><td><form:errors path="date" cssClass="error"></form:errors></td></tr>
