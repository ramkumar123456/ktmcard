...
<form:form action="/KTMCardandE-Ticketing/usereditsave1.html" method="POST">
<table border="0" align="center" cellpadding="3" cellspacing="2">
<%-- <tr><td cssStyle="height:20px">EmployeeID</td><td cssStyle="width:18px;">:</td>
<td><form:input path="employeeid" readonly="true" cssClass="txt" cssStyle="height:18px;"/></td><td><form:errors path="employeeid" cssClass="error"></form:errors></td></tr> --%>
<tr><td cssStyle="height:20px">Firstname</td><td cssStyle="width:18px;">:</td>
<td><form:input path="firstname" cssClass="txt" cssStyle="height:18px;"/></td><td><form:errors path="firstname" cssClass="error"></form:errors></td></tr>
<tr><td cssStyle="height:20px">Middlename</td><td cssStyle="width:18px;">:</td>
<td><form:input path="middlename" cssClass="txt" cssStyle="height:18px;"/></td><td><form:errors path="middlename" cssClass="error"></form:errors></td></tr>
<tr><td cssStyle="height:20px">Lastname</td><td cssStyle="width:18px;">:</td>
<td><form:input path="lastname" cssClass="txt" cssStyle="height:18px;"/></td><td><form:errors path="lastname" cssClass="error"></form:errors></td></tr>
<tr><td cssStyle="height:20px">Username</td><td cssStyle="width:18px;">:</td>
<td><form:input path="username"  readonly="true" cssClass="txt" cssStyle="height:18px;"/></td></tr>
<tr>
<td><form:hidden path="password" /></td></tr>

<tr>
<td><form:hidden path="conformpassword"/></td></tr>
<tr>
<tr><td cssStyle="height:20px">DateOfBirth</td><td cssStyle="width:18px;">:</td>
<td><form:input path="dateofbirth" class="easyui-datebox"  cssStyle="txt:height:12px;"/></td><td><form:errors path="dateofbirth" cssClass="error"></form:errors></td></tr>
<tr><td cssStyle="height:20px">Gender</td><td cssStyle="width:18px;">:</td>
<td><form:radiobutton path="gender" value="male" name="gender" />Male
<form:radiobutton path="gender" value="female" name="gender" />Female
</td><td><form:errors path="gender" cssClass="error"></form:errors></td></tr>
<tr><td cssStyle="height:20px">EmailId</td><td cssStyle="width:18px;">:</td>
<td><form:input path="email" cssClass="txt" cssStyle="height:18px;"/></td><td><form:errors path="email" cssClass="error"></form:errors></td></tr>
<tr><td cssStyle="height:20px">MobileNumber</td><td cssStyle="width:18px;">:</td>
<td><form:input path="mobileno" cssClass="txt" cssStyle="height:18px;"/></td><td><form:errors path="mobileno" cssClass="error"></form:errors></td></tr>
<tr><td cssStyle="height:20px">Address</td><td cssStyle="width:18px;">:</td>
<td><form:textarea path="address" cssClass="txt" cssStyle="width:155px"/></td><td><form:errors path="address" cssClass="error"></form:errors></td></tr>
...
<tr><td cssStyle="height:20px">Country</td><td cssStyle="width:18px;">:</td>
		<td><form:select path="country" id="country" cssClass="txt" cssStyle="width:162px;height:23px"  onchange="getStates(this.value);">
...
<tr><td></td><td></td>
 <td colspan="2" align="left"><input type="submit" value="Update" Class="button"/></td>
 </tr>
</table>
 </form:form>
</div>
