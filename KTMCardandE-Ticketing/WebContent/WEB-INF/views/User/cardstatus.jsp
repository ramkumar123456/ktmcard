...
<h2>Requested Cards</h2>
    ...
    <div style="margin:20px 0;"></div>
     ...
     <table align="center" id="dg" title="List Of RequestedCards" class="easyui-datagrid" style="width:900px;height:250px"

            toolbar="#toolbar" pagination="true"
            rownumbers="true" fitColumns="true" singleSelect="true"
            data-options="singleSelect:true,url:'showcardstatus.html',onDblClickRow:function(index,row){update()},method:'get'">
