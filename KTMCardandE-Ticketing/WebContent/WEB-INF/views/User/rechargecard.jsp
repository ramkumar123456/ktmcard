...
<form:form method="POST" action="rechargepaymentpage1.html">
<center>
<H2>Recharge Your Card</H2></center>
<table border="0" align="center" cellpadding="3" cellspacing="2">
<tr><td cssStyle="height:20px">Enter Your Card Number</td><td><form:input path="firstname"/><td><form:errors path="firstname" cssClass="error" /></td></td></tr>
<tr><td cssStyle="height:20px">Enter Amount</td><td><form:input path="middlename"/></td><td><form:errors path="middlename" cssClass="error" /></td></tr>

<tr><td></td>
 <td colspan="2" align="left"><input type="submit" value="Recharge" Class="button"/></td>
 </tr></table>
</form:form>
</security:authorize>
</body>
