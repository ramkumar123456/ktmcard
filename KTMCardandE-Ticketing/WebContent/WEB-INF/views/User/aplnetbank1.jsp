...
<br><br><br><br>
<h1 align="center">Net Banking PaymentPage</h1>
<form:form action="rechargesus1.html" method="POST">
<table border="0" align="center" cellpadding="3" cellspacing="2">
<tr><td>Username</td><td>:</td>
<td><input type="text" placeholder="UserName"/></td><td></td></tr>
<tr><td>PassWord</td><td>:</td>
<td><input type="text" placeholder="PassWord"/></td><td></td></tr>
