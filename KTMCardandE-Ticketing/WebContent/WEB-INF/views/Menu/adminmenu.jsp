...
<ul id="menu-bar">
  <li><a href="adminhome.html" >Home</a></li>
    ...
    <li><a href="requestedcards.html" >RequestedCards</a></li>
    <li><a href="viewstations.html" >Stations</a></li>
    <li><a href="viewtrains.html" >ViewTrains</a></li>
    <li><a href="#">Profile</a>
  <ul>
   <li><a href="adminupdateprofile.html">UpdateProfile</a></li>
   <li><a href="adminchangepassword.html">ChangePassword</a></li>
  </ul>
  </li>
