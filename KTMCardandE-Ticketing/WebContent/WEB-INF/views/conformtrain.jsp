...
function lng(){
	...
	var eg = document.getElementById("eng").value;
...
<body onload="lng();">
<br>
<h2 align="center">Enter Passenger Details</h2>
<div align="center">
<form:form action="/KTMCardandE-Ticketing/conformticket.html" method="GET">
...
<td><form:input path="employeeid" cssClass="txt" cssStyle="height:18px;" styleId="employeeid" onchange="employee()"/></td><td><span id="eid" style="color:red"></span><form:errors path="employeeid" cssClass="error"></form:errors></td></tr> --%>
