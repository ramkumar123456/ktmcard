...
<body>
<br>
<h2 align="center">Update Counter:</h2>
<div align="center">

<form:form action="/KTMCardandE-Ticketing/updatecountersuccs.html" method="GET">
<table border="0" align="center" cellpadding="3" cellspacing="2">
<tr><td cssStyle="height:20px">UserName</td><td cssStyle="width:18px;">:</td>
<td><form:input path="username" cssClass="txt" cssStyle="height:18px;" styleId="username"/></td><td><form:errors path="username" cssClass="error"></form:errors></td></tr>
...
<td><form:input path="stationname" cssClass="txt" cssStyle="height:18px;" styleId="stationname"/></td><td><form:errors path="stationname" cssClass="error"></form:errors></td></tr>
<tr><td cssStyle="height:20px">StationCode</td><td cssStyle="width:18px;">:</td>
<td><form:input path="stationcode" cssClass="txt" styleId="stationcode" onchange="unique()" cssStyle="height:18px;" /></td><td><span id="sid" style="color:red"></span><form:errors path="stationcode" cssClass="error"></form:errors></td></tr>
...
<td><form:input path="address" cssClass="txt" cssStyle="height:18px;"/></td><td><form:errors path="address" cssClass="error"></form:errors></td></tr>
